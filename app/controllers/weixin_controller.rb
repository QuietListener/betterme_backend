...
class WeixinController < ApplicationController
  ...
  #https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxc8c2179b9a8c63ef&redirect_uri=http%3A%2F%2Fwww.coderlong.com%2Fweixin%2Fwein_login_call_back_snsapi_base&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect
  ...
  def get_share_config
    url = "http://21bebd7c.ngrok.io/home"
